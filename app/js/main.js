...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsAppJsx = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _quizBoxScoreJsx = __webpack_require__(170);

	var _quizBoxScoreJsx2 = _interopRequireDefault(_quizBoxScoreJsx);

	var _quizQuestionListJsx = __webpack_require__(171);

	var _quizQuestionListJsx2 = _interopRequireDefault(_quizQuestionListJsx);

	var _quizResultsJsx = __webpack_require__(173);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      if (this.state.current > this.state.questions.length) {
	        ...
	        var boxscore = _react2['default'].createElement(_quizBoxScoreJsx2['default'], this.state);
	        var results = '';
	      }
	      return _react2['default'].createElement(
	        ...
	        null,
	        boxscore,
	        _react2['default'].createElement(_quizQuestionListJsx2['default'], _extends({ setScore: this.setScore.bind(this), setCurrent: this.setCurrent.bind(this) }, this.state)),
	        results
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BoxScore = (function (_React$Component) {
	  _inherits(BoxScore, _React$Component);

	  function BoxScore() {
	    _classCallCheck(this, BoxScore);

	    _get(Object.getPrototypeOf(BoxScore.prototype), "constructor", this).apply(this, arguments);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _QuestionJsx = __webpack_require__(172);
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        this.props.questions.map(function (question) {
	          if (_this.props.current === question.id) {
	        ...
	        _react2["default"].createElement(
	          ...
	          question.choices.map(function (choice) {
	            return _react2["default"].createElement(
	              ...
	              choice.id,
	              _react2["default"].createElement("input", { onChange: _this.handleChange.bind(_this), type: "radio", name: question.id, value: choice.id }),
	              " ",
	              choice.text
	            );
	          })
